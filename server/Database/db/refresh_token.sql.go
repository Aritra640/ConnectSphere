...
SELECT id, user_id, token, expires_at, created_at FROM refresh_token WHERE user_id = $1
`

func (q *Queries) GetRefreshTokenByUserId(ctx context.Context, userID sql.NullInt32) (RefreshToken, error) {
